...
function Basket() {
  const { pizzasList, totalCount, totalPrice } = useSelector(basketSelector);
        ...
        <div className="cart">
          <div className="cart__top">
            ...
            <div className="cart__clear">
              ...
              <span onClick={handleClearBasket}>Очистить корзину</span>
            </div>
          </div>
          <div className="basket__items">
            {pizzasList.map((item) => {
              return <BasketItem {...item} key={`${item.id}_${item.type}_${item.size}`} />;
            })}
          </div>
