...
import { changeSearch, resetSearch } from '../../store/search/SearchSlice';
import { changeIsEnd } from '../../store/pizzas/pizzasSlice';
import { searchSelector } from '../../store/search/searchSelector';
import { useAppDispatch } from '../../store/store';

type DebouncedFunctionType = (value: string) => void;
const Search = () => {
  const search = useSelector(searchSelector);
  const dispatch = useAppDispatch();

  const debouncedChangeSearch: DebouncedFunctionType = React.useCallback(
